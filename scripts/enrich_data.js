...
// Batch 5 — missing Algomaster / Striver slugs and theory names
const BATCH_5 = {
    // Slugs
    ...
    "longest-balanced-subarray-ii": "Medium",
    ...
    "minimum-cost-path-with-edge-reversals": "Hard",
    ...
    "painting-a-grid-with-three-different-colors": "Hard",
    ...
    "Requirements needed to construct a unique BT": "Medium",
    "Bit PreRequisites for TRIE Problems": "Easy",
    "Introduction to Trees": "Easy",
    "Introduction": "Easy",
    "Binary Tree Representation in Java": "Easy",
    "Pre, Post, Inorder in one traversal": "Medium",
    "Preorder, Inorder, and Postorder Traversal in one Traversal": "Medium",
    "Introduction to BST": "Easy",
    "Find Min/Max in BST": "Easy",
    "Heaps (Theory Video)": "Easy",
    "Implement Min Heap": "Medium",
    "Check if an array represents a min heap": "Easy",
    "Convert Min Heap to Max Heap": "Medium",
    "Connected Components": "Medium",
    "DFS": "Easy",
    "Why priority Queue is used in Djisktra's Algorithm": "Easy",
    "Disjoint Set": "Medium",
    "MST theory": "Easy",
    "Find the MST weight": "Medium",
    "Introduction to Graph": "Easy",
    "Graph Representation | C++": "Easy",
    "Graph Representation | Java": "Easy",
    "Traversal Techniques": "Easy",
    "Introduction to DP": "Easy",
    "Number Factors": "Medium",
    "Count Ways to Score in a Game": "Medium",
    "Maximum Ribbon Cut": "Medium",
    "Rod Cutting": "Medium",
    "Minimum Deletions in a String to make it a Palindrome": "Medium",
    "Matrix Chain Multiplication": "Hard",
    "The Catalan Numbers": "Medium",
    "Minimum Deletions to Make a Sequence Sorted": "Medium",
    ...
    "Introduction to Bits and Tricks": "Easy",
    "Divisors of a Number": "Easy",
    "Prime factorisation of a Number": "Easy",
    "Print subarray with maximum subarray sum (extended version of above problem)": "Medium",
    "Special Binary String": "Hard",
    "Longest Nice Substring": "Easy",
    "Number of Distinct Substrings in a String": "Medium",
    "Find All Numbers Disappeared in Array": "Easy",
    "Largest Element": "Easy",
    ...
    "Implement queue using Linkedlist": "Easy"
};

for (const k in BATCH_5) {
    if (!DIFFICULTY_MAP[k]) DIFFICULTY_MAP[k] = BATCH_5[k];
}
...
for (const cat in merged) {
    ...
    for (const sub in merged[cat]) {
        ...
        for (const p of merged[cat][sub]) {
            ...
            if (!diff && p.name) {
                // Try fallback by problem exact name (for theories and array operations lacking slugs)
                diff = DIFFICULTY_MAP[p.name] || '';
            }
